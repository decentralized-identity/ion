...
- ION is not a sidechain or consensus system - the network nodes do not require any additional consensus mechanism, they apply the same logical set of rules to arrive at the 'correct' PKI state for IDs in the system.
